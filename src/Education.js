    ...
    <section id="education" className="py-8 bg-gray-100 w-full">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
          <div className="education-card animate__animated animate__fadeInTopLeft">
          ...
          <div className="education-card animate__animated animate__fadeInTopRight">
          ...
          <div className="education-card animate__animated animate__fadeInBottomLeft">
          ...
          <div className="education-card animate__animated animate__fadeInBottomRight">
